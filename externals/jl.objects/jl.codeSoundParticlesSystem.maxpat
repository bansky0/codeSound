...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 1120.0, 243.0, 67.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1120.0, 203.0, 85.0, 22.0 ],
					"text" : "presentation 1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1120.0, 168.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1120.0, 132.0, 70.0, 22.0 ],
					"text" : "loadmess 1"
				}
...
,
					"patching_rect" : [ 755.0, 481.0, 158.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 267.0, 248.0, 72.0, 62.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 550.0, 409.0, 106.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 755.0, 527.0, 45.0, 22.0 ],
					"text" : "s prest"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 894.0, 530.0, 37.0, 22.0 ],
					"text" : "s lfo2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 824.5, 530.0, 37.0, 22.0 ],
					"text" : "s lfo1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 482.0, 409.0, 61.0, 22.0 ],
					"text" : "route size"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 482.0, 442.0, 67.0, 22.0 ],
					"text" : "unpack 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 216.0, 535.0, 60.0, 22.0 ],
					"text" : "select 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 259.0, 587.0, 29.0, 29.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 259.0, 622.5, 98.0, 36.0 ],
					"text" : ";\r\nmax showcursor"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 154.0, 587.0, 29.0, 29.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 154.0, 622.5, 93.0, 36.0 ],
					"text" : ";\r\nmax hidecursor"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 211.0, 307.0, 24.0, 24.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 90.0, 49.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 211.0, 277.0, 57.0, 22.0 ],
					"text" : "select 32"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 211.0, 248.0, 50.5, 22.0 ],
					"text" : "key"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 639.0, 236.0, 150.0, 34.0 ],
					"text" : "assing values to diferent parameters"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 553.0, 261.0, 87.0, 22.0 ],
					"text" : "unpack 0. 0. 0."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 550.0, 306.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 553.0, 230.0, 40.0, 22.0 ],
					"text" : "jit.iter"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 281.0, 415.0, 114.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"text" : "mouseidleout 150 -4 0 0 0 0 0 0"
								}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 189.0, 455.0, 150.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.0, 302.0, 75.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 17.0, 85.0, 97.0, 22.0 ],
					"text" : "getsize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 340.0, 535.0, 395.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 454.0, 501.0, 93.0, 20.0 ],
					"text" : "new position"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 340.0, 500.0, 98.0, 22.0 ],
...
,
					"patching_rect" : [ 340.0, 464.0, 81.0, 22.0 ],
					"text" : "jit.gen update"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 335.0, 80.0, 81.0, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 90.0, 15.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 35.0, 374.0, 466.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 35.0, 71.0, 63.0, 22.0 ],
					"text" : "qmetro 15"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 17.0, 15.0, 58.0, 58.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.0, 344.0, 173.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 211.0, 344.0, 150.0, 22.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 368.5, 339.0, 411.5, 339.0 ],
					"source" : [ "obj-10", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 491.5, 399.0, 198.5, 399.0 ],
					"order" : 1,
					"source" : [ "obj-17", 1 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 44.5, 60.0, 21.0, 60.0, 21.0, 288.0, 44.5, 288.0 ],
					"order" : 1,
					"source" : [ "obj-2", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 433.5, 144.0, 411.0, 144.0, 411.0, 228.0, 345.0, 228.0, 345.0, 339.0, 405.0, 339.0, 405.0, 450.0, 349.5, 450.0 ],
					"order" : 1,
					"source" : [ "obj-24", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-58", 0 ],
					"midpoints" : [ 220.5, 333.0, 198.0, 333.0, 198.0, 288.0, 21.0, 288.0, 21.0, 522.0, 225.5, 522.0 ],
					"order" : 0,
					"source" : [ "obj-35", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 349.5, 488.0, 349.5, 488.0 ],
					"source" : [ "obj-37", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 349.5, 524.0, 349.5, 524.0 ],
					"source" : [ "obj-38", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-17", 0 ],
					"midpoints" : [ 44.5, 327.0, 30.0, 327.0, 30.0, 369.0, 44.5, 369.0 ],
					"source" : [ "obj-49", 0 ]
				}
