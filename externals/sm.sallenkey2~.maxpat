...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "", "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 138.061187999999987, 324.0, 84.10546875, 19.4990234375 ],
					"text" : "sm.sallenkey~",
					"texton" : "sm.sallenkey~",
...
, 			{
				"box" : 				{
					"comment" : "(signal) Saturated MS20-ish Output Right",
					"id" : "obj-4",
					"index" : 2,
					"maxclass" : "outlet",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"comment" : "(signal) Saturated MS20-ish Output Left ( filter currently: BYPASSED / saturation currently: PRE & four_times_oversampled )",
					"id" : "obj-44",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
